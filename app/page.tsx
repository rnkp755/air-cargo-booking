        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background to-muted/20">
          <div className="container mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Fast, reliable, and secure air cargo booking for global shipping solutions. Track your shipments in
              real-time with our professional platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="text-lg px-8 hover:bg-primary/90 transition-colors">
                <Link href="/routes">Search Routes</Link>
              </Button>
              <Button
                asChild
                variant="outline"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-3xl font-bold mb-4">Why Choose AirCargo Pro?</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Experience the difference with our professional air cargo services
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-slide-in">
                ...
                <CardContent>
                  <CardDescription>
                    Express air cargo services with guaranteed delivery times and real-time tracking.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <CardDescription>
                    Professional cargo handling with full insurance coverage and security protocols.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <CardDescription>
                    Worldwide coverage with direct and transit routes to major destinations.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              >
                ...
                <CardContent>
                  <CardDescription>
                    Complete visibility of your shipment from pickup to delivery with live updates.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
          <div className="container mx-auto text-center animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Get started with our professional air cargo booking platform today
            </p>
            <Button asChild size="lg" className="text-lg px-8 hover:bg-primary/90 transition-colors">
              <Link href="/routes">Book Your Shipment</Link>
            </Button>
          </div>
        </section>
      </main>
