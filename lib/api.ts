...
// API functions
export const searchRoutes = async (data: RouteSearchRequest): Promise<RouteSearchResponse> => {
...
export const getBookingHistory = async (refId: string): Promise<BookingHistoryResponse> => {
